...
// Redirect to login if not logged in or not an employer
...
<body>
    ...
    <header class="header">
        <section class="flex">
            ...
            <a href="employer_home.php" class="logo"><i class="fas fa-briefcase"></i> JobNest</a>
            <nav class="navbar">
        ...
        <div class="container">
            ...
            <div class="actions">
                ...
                <div class="button-group">
                    <a href="post1.php" class="btnn">Post a new job</a>
                    <a href="view_application.php" class="btnn">View applications</a>
                    <a href="manage_jobs.php" class="btnn">Manage your jobs</a>
                    <a href="search_talent.php" class="btnn">Search Talent</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <!--Job section starts-->
    <section id="jobCategories" class="category">
